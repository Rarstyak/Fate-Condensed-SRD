...
- **[[X-Card|The X-Card]]:** The X-Card is an optional tool (created by [[John Stavropoulos|John Stavropoulos]]) that allows anyone in your game (including you) to edit out any content anyone is uncomfortable with as you play. You can learn more about the X-Card at [http://tinyurl.com/x-card-rpg](http://tinyurl.com/x-card-rpg)
