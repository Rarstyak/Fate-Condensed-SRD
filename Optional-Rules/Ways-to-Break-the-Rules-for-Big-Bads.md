...
You could **[scale things up](Scale.md)** to let your big bad operate at a higher scale than the PCs. You could do this even if scale isn’t normally in play in your campaign—these rules need only apply when a big bad takes the field!
...
In Fate, anything can be a character, so why not a map? When **the threat is a map**, your big bad has **[zones](../Challenges-Conflicts-and-Contests/Setting-Up-Scenes/Zones.md)** which must be navigated to achieve victory.
